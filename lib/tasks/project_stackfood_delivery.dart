...
class ProjectStackfoodDelivery extends StatelessWidget {
  const ProjectStackfoodDelivery({super.key});
  ...
  Widget build(BuildContext context) {
    return WhiteBoxWidget(
      ...
      child: Column(
        children: [
          Image.asset(Images.stackfoodDelivery),

          Text("Stackfood Delivery Man App", style: Style.textStyleBold),
          const SizedBox(height: 5),
        
          Text(
            "This is a Multi-vendor E-commerce app's Delivery app. Which is use to maintain the system's delivery system.",
