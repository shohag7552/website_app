...
class Project6amMartWidget extends StatelessWidget {
  const Project6amMartWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return WhiteBoxWidget(
      ...
      child: Column(
        children: [
          Image.asset(Images.ammart),

          Text("6amMart", style: Style.textStyleBold),
          const SizedBox(height: 5),
        
          Text(
            "This is a Multi-vendor E-commerce app that allows users to buy products from multiple vendors.",
